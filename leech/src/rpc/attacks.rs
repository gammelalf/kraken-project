...
use kraken_proto::{
    ...
    DnsResolutionRequest, DnsTxtScanRequest, HostsAliveRequest, ServiceDetectionRequest,
    ServiceDetectionResponse, TcpPortScanRequest, UdpServiceDetectionRequest,
};
use tokio::sync::mpsc;
...
use crate::modules::port_scanner::tcp_con::TcpPortScanner;
use crate::modules::service_detection::udp::UdpServiceDetection;
use crate::modules::service_detection::ServiceDetection;
use crate::modules::{Attack, StreamedAttack};
...
impl ReqAttackService for Attacks {
    ...
    async fn service_detection(
        ...
        self.normal_attack::<ServiceDetection>(request).await
    }
